...
$(function () {
	...
	if ($(".front-top").length) {
		...
		function titleSliderResize() {
			let w = $(".front-top__subtitle-slider span._active").width();

			$(".front-top__subtitle-slider").css("width", w);
		...
		setInterval(function () {
			let lng = 6;
			$(".front-top__subtitle-slider span").stop().fadeOut(300);
			...
			$(".front-top__subtitle-slider  span")
				.eq(indx - 1)
				.addClass("_active");
			$(".front-top__subtitle-slider")
				.eq(indx - 1)
				.addClass("_active");
			gsap.to(".front-top__subtitle-slider", {
				duration: 0.5,
				width: $(".front-top__subtitle-slider ._active").innerWidth(),
			});
			$(".front-top__subtitle-slider span")
				.eq(indx - 1)
				.stop()
...
$(function () {
	...
	var $svg = $(".preloader__logo svg").drawsvg({
		duration: 3000,
	});
	$svg.drawsvg("animate");

	$(".header__city").click(function () {
		$(".preloader").scrollLeft((1300 - window.innerWidth) / 2);
	...
	setTimeout(function () {
		...
		setTimeout(function () {
			...
			$(document).mousemove(function (event) {
				...
				$(".preloader__cities").each(function () {
